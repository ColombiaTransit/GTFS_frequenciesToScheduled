...
def main(argv):
    ...
    agency.to_csv(new_route + "\\agency.txt", header=True, index=False, sep=',')
    calendar.to_csv(new_route + "\\calendar.txt", header=True, index=False, sep=',')
    calendar_dates.to_csv(new_route + "\\calendar_dates.txt", header=True, index=False, sep=',')
    feed_info.to_csv(new_route + "\\feed_info.txt", header=True, index=False, sep=',')
    routes.to_csv(new_route + "\\routes.txt", header=True, index=False, sep=',')
    shapes.to_csv(new_route + "\\shapes.txt", header=True, index=False, sep=',')
    stops.to_csv(new_route + "\\stops.txt", header=True, index=False, sep=',')
